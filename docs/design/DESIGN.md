# DESIGN.md — Dirección visual de Bynoesis

> Cómo se ve y se siente Bynoesis. Fijado con el founder 2026-07-08. Lee antes
...
**La app no es un tablero que lees; es un parte que recibes.** Cada mañana Bynoesis
...
## 3. La persona: Bynoesis habla

Bynoesis es una **figura con carácter**, no una voz neutra de sistema. Se dirige al
...
Bynoesis se distingue de los datos:

- **Voz de Bynoesis** (el parte, los titulares, las recomendaciones): serif editorial
  (Fraunces). Da calidez y presencia; "alguien te habla".
- **Datos** (importes, tablas, formularios): sans limpia (Inter). Precisión.

Esa dualidad serif-voz / sans-dato es la firma tipográfica de Bynoesis y ya existe a
...
1. **Parte de Bynoesis** — una lectura breve en lenguaje humano, con la marca:
...
Bynoesis      · el asistente, la memoria del negocio, automatizaciones
...
- **El "+ Crear"** abre acciones reales (factura, feina, gasto, presupuesto,
  preguntar a Bynoesis), no un formulario.
- **Bynoesis es una capa persistente**, no una pestaña: presente en todas las pantallas
  ("Preguntar a Bynoesis sobre esto").
...
piloto real lo pida. Se pregunta en el onboarding: *"¿Cómo quieres que Bynoesis te
explique el negocio?"*.
...
1. **Rediseño primero, software después.** Se rediseña toda la app con esta visión
   (piel + lenguaje + Home como parte + Bynoesis persistente) **antes** de introducir
...
4. **Agenda-gestor**: el norte es que Bynoesis reorganice y agende solo; se diseña la
...
- El **Inicio** deja de ser KPIs+gráficas y pasa a ser el **parte de Bynoesis**.
