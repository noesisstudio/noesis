# Registro de actividades de tratamiento de Noesis

Versión interna: 2026-09-03. Propietario operativo: dirección de Noesis.
...
## 1. Noesis como responsable: cuenta y relación comercial
...
| Datos | Identificación y contacto; negocio y configuración; datos fiscales de la cuenta; referencias de Stripe; consentimientos; soporte; eventos de seguridad; solicitudes de privacidad. Noesis no almacena el número completo de tarjeta. |
...
| Origen | La propia persona, el uso de Noesis y los proveedores de identidad/pago que ella inicia. |

## 2. Noesis como responsable: seguridad y continuidad
...
## 3. Noesis como encargado: operación del negocio cliente

| Campo | Descripción |
|---|---|
| Responsables | Cada autónomo, empresa o gestoría que contrata Noesis respecto de los datos que introduce de terceros. |
