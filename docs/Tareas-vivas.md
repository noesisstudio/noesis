...
- [ ] Desplegar el `main` actual, aplicar la migración indicada en
  ...
  textos legales y alta cerrada ya se comprobaron el 6-ago; falta publicar y repetir
  la nueva redirección 308 de `www`, además de las pruebas autenticadas restantes.
