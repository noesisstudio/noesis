...
## Estado en una frase
Prototipo funcional: app web multipágina (FastAPI) con login, dashboard, asistente
local, fiscalidad correcta y diseño de marca. Falta conectar lo real (Holded,
WhatsApp, despliegue). Ver [[Roadmap]].
